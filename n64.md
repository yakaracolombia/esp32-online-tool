...
si queremos usar nuestro control bluetooth de n64 en una consola n64 con blueretro es totalmente **OBLIGATORIO** tener instalada la version 1.8.2 (o superior) de blueretro [COMO LO VIMOS EN ESTE TUTORIAL](https://github.com/HandHeldLegend/HOJA-LIB-ESP32) de manera inalambrica sin conectar el esp32 a nuestro pc, o si podemos conectar podremos hacer una instalacion [desde este enlace](https://www.mundoyakara.com/2022/07/hacer-control-arcade-bluetooth.html)
